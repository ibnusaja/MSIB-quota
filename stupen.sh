...
echo
echo -e " \e[32;1m########################################################\e[0m"
echo -e " \e[32;1m##\e[0m      \e[35;1mPengecekan Kuota Tersedia Stupen MSIB 6.      \e[0m\e[32;1m##\e[0m"
...
echo -e "\e[31;1m
 ket :
   1. jika \e[0m available_to_apply \e[31;1mbernilai\e[0m \e[38;1mtrue, \e[0m\e[31;1m maka masih buka pendaftaran (karena kamdek belum nutup pendaftaran)
   2. jika \e[0m quota_full\e[0m \e[31;1mbernilai\e[0m \e[38;1mtrue,\e[0m \e[31;1mmaka anda tidak bisa daftar (karena karena mitra sudah memenuhi kuota target).
\e[0m
"
